...
enum yeetcState {
  yeetc_STATE_IDLE = 0,
  yeetc_STATE_STABILISING,
  yeetc_STATE_WAITING,
};

class yeetcComponent : public uart::UARTDevice, public Component {
 public:
  yeetcComponent() = default;
  void loop() override;
  float get_setup_priority() const override;
  void dump_config() override;

  void set_type(yeetcType type) { type_ = type; }
 ...
 protected:
  ...
  yeetcState state_{yeetc_STATE_IDLE};
  yeetcType type_;
